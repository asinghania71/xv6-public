...
80100c51:	e8 0a 62 00 00       	call   80106e60 <copyout>
...
80100cb5:	89 8d 60 ff ff ff    	mov    %ecx,-0xa0(%ebp)
  ...
  sp -= (3+argc+1) * 4;
  if(copyout(pgdir, sp, ustack, (3+argc+1)*4) < 0)
80100cbb:	e8 a0 61 00 00       	call   80106e60 <copyout>
...
80101165:	68 bf 6f 10 80       	push   $0x80106fbf
...
80101212:	68 d2 6f 10 80       	push   $0x80106fd2
...
80101344:	68 e8 6f 10 80       	push   $0x80106fe8
...
8010140a:	68 f8 6f 10 80       	push   $0x80106ff8
...
80101e98:	68 5e 76 10 80       	push   $0x8010765e
...
80102e12:	e8 a9 28 00 00       	call   801056c0 <idtinit>
...
80102e33:	83 ec 08             	sub    $0x8,%esp
  switchkvm();
80102e36:	e8 f5 39 00 00       	call   80106830 <switchkvm>
  seginit();
80102e3b:	e8 60 38 00 00       	call   801066a0 <seginit>
  lapicinit();
...
80102e99:	e8 62 2b 00 00       	call   80105a00 <uartinit>
  pinit();         // process table
80102e9e:	e8 0d 08 00 00       	call   801036b0 <pinit>
  tvinit();        // trap vectors
80102ea3:	e8 78 27 00 00       	call   80105620 <tvinit>
  binit();         // buffer cache
...
80103614:	89 53 18             	mov    %edx,0x18(%ebx)
  ...
  sp -= 4;
  *(uint*)sp = (uint)trapret;
80103617:	c7 40 14 12 56 10 80 	movl   $0x80105612,0x14(%eax)
...
801037b3:	e8 98 34 00 00       	call   80106c50 <setupkvm>
...
801037d1:	e8 8a 31 00 00       	call   80106960 <inituvm>
  p->sz = PGSIZE;
...
801038be:	e8 dd 31 00 00       	call   80106aa0 <allocuvm>
...
801038d0:	e8 7b 2f 00 00       	call   80106850 <switchuvm>
  return 0;
...
801038f4:	e8 a7 32 00 00       	call   80106ba0 <deallocuvm>
...
80103948:	e8 d3 33 00 00       	call   80106d20 <copyuvm>
...
80103a8b:	83 c3 7c             	add    $0x7c,%ebx
      ...
      c->proc = p;
      switchuvm(p);
80103a8e:	e8 bd 2d 00 00       	call   80106850 <switchuvm>
      p->state = RUNNING;
...
80103aa0:	e8 c6 0b 00 00       	call   8010466b <swtch>
      switchkvm();
80103aa5:	e8 86 2d 00 00       	call   80106830 <switchkvm>
...
80103e70:	c7 43 08 00 00 00 00 	movl   $0x0,0x8(%ebx)
        freevm(p->pgdir);
80103e77:	e8 54 2d 00 00       	call   80106bd0 <freevm>
        p->pid = 0;
...
80103fdb:	68 bf 78 10 80       	push   $0x801078bf
...
801042c5:	68 9a 75 10 80       	push   $0x8010759a
...
801042d2:	68 83 75 10 80       	push   $0x80107583
...
801043b3:	68 a1 75 10 80       	push   $0x801075a1
...
801043fc:	68 a9 75 10 80       	push   $0x801075a9
...
8010482a:	8b 14 85 e0 75 10 80 	mov    -0x7fef8a20(,%eax,4),%edx
...
80104850:	68 b1 75 10 80       	push   $0x801075b1
...
801049b4:	68 54 76 10 80       	push   $0x80107654
...
801049cc:	68 53 76 10 80       	push   $0x80107653
...
801049e1:	68 47 76 10 80       	push   $0x80107647
...
801049ee:	68 56 76 10 80       	push   $0x80107656
...
801049fb:	68 38 76 10 80       	push   $0x80107638
...
80104e0d:	58                   	pop    %eax
80104e0e:	5a                   	pop    %edx
80104e0f:	68 54 76 10 80       	push   $0x80107654
...
80104e28:	68 53 76 10 80       	push   $0x80107653
...
80104f7d:	68 78 76 10 80       	push   $0x80107678
...
80104f8a:	68 8a 76 10 80       	push   $0x8010768a
...
80104f97:	68 66 76 10 80       	push   $0x80107666
...
8010551d:	eb ed                	jmp    8010550c <sys_sbrk+0x2c>
8010551f:	90                   	nop
...
80105540:	68 60 4c 11 80       	push   $0x80114c60
...
8010554d:	83 c4 10             	add    $0x10,%esp
  ...
  acquire(&tickslock);
  ticks0 = ticks;
80105550:	8b 1d a0 54 11 80    	mov    0x801154a0,%ebx
  while(ticks - ticks0 < n){
...
80105563:	68 60 4c 11 80       	push   $0x80114c60
80105568:	68 a0 54 11 80       	push   $0x801154a0
8010556d:	e8 ae e7 ff ff       	call   80103d20 <sleep>
  ...
  ticks0 = ticks;
  while(ticks - ticks0 < n){
80105572:	a1 a0 54 11 80       	mov    0x801154a0,%eax
...
8010557f:	73 2f                	jae    801055b0 <sys_sleep+0x90>
    if(myproc()->killed){
80105581:	e8 ea e1 ff ff       	call   80103770 <myproc>
...
80105595:	e8 26 ee ff ff       	call   801043c0 <release>
      return -1;
...
801055b8:	e8 03 ee ff ff       	call   801043c0 <release>
  return 0;
...
801055d4:	83 ec 10             	sub    $0x10,%esp
  ...
  acquire(&tickslock);
801055d7:	68 60 4c 11 80       	push   $0x80114c60
801055dc:	e8 2f ed ff ff       	call   80104310 <acquire>
  xticks = ticks;
801055e1:	8b 1d a0 54 11 80    	mov    0x801154a0,%ebx
  release(&tickslock);
801055e7:	c7 04 24 60 4c 11 80 	movl   $0x80114c60,(%esp)
801055ee:	e8 cd ed ff ff       	call   801043c0 <release>
  return xticks;
}
...
80105634:	c6 04 c5 a4 4c 11 80 	movb   $0x0,-0x7feeb35c(,%eax,8)
8010563b:	00 
8010563c:	66 89 0c c5 a2 4c 11 	mov    %cx,-0x7feeb35e(,%eax,8)
80105643:	80 
80105644:	c6 04 c5 a5 4c 11 80 	movb   $0x8e,-0x7feeb35b(,%eax,8)
8010564b:	8e 
8010564c:	66 89 14 c5 a0 4c 11 	mov    %dx,-0x7feeb360(,%eax,8)
80105653:	80 
80105654:	c1 ea 10             	shr    $0x10,%edx
80105657:	66 89 14 c5 a6 4c 11 	mov    %dx,-0x7feeb35a(,%eax,8)
8010565e:	80 
void
tvinit(void)
{
...
80105679:	68 99 76 10 80       	push   $0x80107699
8010567e:	68 60 4c 11 80       	push   $0x80114c60
{
  int i;
  ...
  for(i = 0; i < 256; i++)
    SETGATE(idt[i], 0, SEG_KCODE<<3, vectors[i], 0);
  SETGATE(idt[T_SYSCALL], 1, SEG_KCODE<<3, vectors[T_SYSCALL], DPL_USER);
80105683:	66 89 15 a2 4e 11 80 	mov    %dx,0x80114ea2
8010568a:	c6 05 a4 4e 11 80 00 	movb   $0x0,0x80114ea4
80105691:	66 a3 a0 4e 11 80    	mov    %ax,0x80114ea0
80105697:	c1 e8 10             	shr    $0x10,%eax
8010569a:	c6 05 a5 4e 11 80 ef 	movb   $0xef,0x80114ea5
801056a1:	66 a3 a6 4e 11 80    	mov    %ax,0x80114ea6

  initlock(&tickslock, "time");
801056a7:	e8 04 eb ff ff       	call   801041b0 <initlock>
}
...
80105702:	0f 84 d8 01 00 00    	je     801058e0 <trap+0x1f0>
    if(myproc()->killed)
      exit();
    return;
  }
...
80105710:	ff 24 85 40 77 10 80 	jmp    *-0x7fef88c0(,%eax,4)
80105717:	89 f6                	mov    %esi,%esi
80105719:	8d bc 27 00 00 00 00 	lea    0x0(%edi,%eiz,1),%edi
      va = PGROUNDDOWN(va);
      mappages(myproc()->pgdir, (char *)va, PGSIZE, (uint)base - KERNBASE, PTE_W|PTE_U);
}break;     
  //PAGEBREAK: 13
  default:
    if(myproc() == 0 || (tf->cs&3) == 0){
80105720:	e8 4b e0 ff ff       	call   80103770 <myproc>
80105725:	85 c0                	test   %eax,%eax
80105727:	0f 84 27 02 00 00    	je     80105954 <trap+0x264>
8010572d:	f6 47 3c 03          	testb  $0x3,0x3c(%edi)
80105731:	0f 84 1d 02 00 00    	je     80105954 <trap+0x264>
...
80105775:	68 fc 76 10 80       	push   $0x801076fc
...
80105782:	e8 e9 df ff ff       	call   80103770 <myproc>
...
80105790:	e8 db df ff ff       	call   80103770 <myproc>
80105795:	85 c0                	test   %eax,%eax
80105797:	74 0c                	je     801057a5 <trap+0xb5>
80105799:	e8 d2 df ff ff       	call   80103770 <myproc>
...
801057a5:	e8 c6 df ff ff       	call   80103770 <myproc>
801057aa:	85 c0                	test   %eax,%eax
801057ac:	74 0b                	je     801057b9 <trap+0xc9>
801057ae:	e8 bd df ff ff       	call   80103770 <myproc>
...
801057c2:	e8 a9 df ff ff       	call   80103770 <myproc>
...
801057d9:	0f 84 2a 01 00 00    	je     80105909 <trap+0x219>
    exit();
}
...
801057fb:	75 a8                	jne    801057a5 <trap+0xb5>
    exit();
801057fd:	e8 9e e3 ff ff       	call   80103ba0 <exit>
...
8010580c:	75 ab                	jne    801057b9 <trap+0xc9>
     tf->trapno == T_IRQ0+IRQ_TIMER)
    yield();
8010580e:	e8 bd e4 ff ff       	call   80103cd0 <yield>
...
80105815:	8d 76 00             	lea    0x0(%esi),%esi
  ...
  case T_PGFLT :{
      char *base = kalloc();
80105818:	e8 63 cc ff ff       	call   80102480 <kalloc>
      memset(base,0,PGSIZE);
8010581d:	83 ec 04             	sub    $0x4,%esp
  ...
  case T_PGFLT :{
      char *base = kalloc();
80105820:	89 c3                	mov    %eax,%ebx
      memset(base,0,PGSIZE);
80105822:	68 00 10 00 00       	push   $0x1000
80105827:	6a 00                	push   $0x0
80105829:	50                   	push   %eax
8010582a:	e8 e1 eb ff ff       	call   80104410 <memset>
8010582f:	0f 20 d6             	mov    %cr2,%esi
      uint va = rcr2();
      va = PGROUNDDOWN(va);
      mappages(myproc()->pgdir, (char *)va, PGSIZE, (uint)base - KERNBASE, PTE_W|PTE_U);
80105832:	81 c3 00 00 00 80    	add    $0x80000000,%ebx
80105838:	81 e6 00 f0 ff ff    	and    $0xfffff000,%esi
8010583e:	e8 2d df ff ff       	call   80103770 <myproc>
80105843:	c7 04 24 06 00 00 00 	movl   $0x6,(%esp)
8010584a:	53                   	push   %ebx
8010584b:	68 00 10 00 00       	push   $0x1000
80105850:	56                   	push   %esi
80105851:	ff 70 04             	pushl  0x4(%eax)
80105854:	e8 47 0f 00 00       	call   801067a0 <mappages>
}break;     
80105859:	83 c4 20             	add    $0x20,%esp
8010585c:	e9 2f ff ff ff       	jmp    80105790 <trap+0xa0>
80105861:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
  ...
  case T_IRQ0 + IRQ_TIMER:
    if(cpuid() == 0){
80105868:	e8 e3 de ff ff       	call   80103750 <cpuid>
8010586d:	85 c0                	test   %eax,%eax
8010586f:	0f 84 ab 00 00 00    	je     80105920 <trap+0x230>
    }
    lapiceoi();
    break;
  case T_IRQ0 + IRQ_IDE:
    ideintr();
    lapiceoi();
80105875:	e8 86 ce ff ff       	call   80102700 <lapiceoi>
    break;
8010587a:	e9 11 ff ff ff       	jmp    80105790 <trap+0xa0>
8010587f:	90                   	nop
...
80105885:	e8 76 ce ff ff       	call   80102700 <lapiceoi>
    break;
8010588a:	e9 01 ff ff ff       	jmp    80105790 <trap+0xa0>
8010588f:	90                   	nop
...
80105895:	e8 66 ce ff ff       	call   80102700 <lapiceoi>
    break;
8010589a:	e9 f1 fe ff ff       	jmp    80105790 <trap+0xa0>
8010589f:	90                   	nop
  case T_IRQ0 + 7:
...
801058a7:	e8 a4 de ff ff       	call   80103750 <cpuid>
801058ac:	56                   	push   %esi
801058ad:	53                   	push   %ebx
801058ae:	50                   	push   %eax
801058af:	68 a4 76 10 80       	push   $0x801076a4
801058b4:	e8 a7 ad ff ff       	call   80100660 <cprintf>
            cpuid(), tf->cs, tf->eip);
    lapiceoi();
801058b9:	e8 42 ce ff ff       	call   80102700 <lapiceoi>
    break;
801058be:	83 c4 10             	add    $0x10,%esp
801058c1:	e9 ca fe ff ff       	jmp    80105790 <trap+0xa0>
...
801058c9:	8d bc 27 00 00 00 00 	lea    0x0(%edi,%eiz,1),%edi
  ...
  case T_IRQ0 + IRQ_IDE:
    ideintr();
801058d0:	e8 6b c7 ff ff       	call   80102040 <ideintr>
801058d5:	eb 9e                	jmp    80105875 <trap+0x185>
...
trap(struct trapframe *tf)
{
  if(tf->trapno == T_SYSCALL){
    if(myproc()->killed)
801058e0:	e8 8b de ff ff       	call   80103770 <myproc>
801058e5:	8b 58 24             	mov    0x24(%eax),%ebx
801058e8:	85 db                	test   %ebx,%ebx
801058ea:	75 2c                	jne    80105918 <trap+0x228>
      exit();
    myproc()->tf = tf;
801058ec:	e8 7f de ff ff       	call   80103770 <myproc>
801058f1:	89 78 18             	mov    %edi,0x18(%eax)
    syscall();
801058f4:	e8 17 ef ff ff       	call   80104810 <syscall>
    if(myproc()->killed)
801058f9:	e8 72 de ff ff       	call   80103770 <myproc>
801058fe:	8b 48 24             	mov    0x24(%eax),%ecx
80105901:	85 c9                	test   %ecx,%ecx
80105903:	0f 84 d6 fe ff ff    	je     801057df <trap+0xef>
    yield();
...
8010591d:	eb cd                	jmp    801058ec <trap+0x1fc>
8010591f:	90                   	nop
  }
...
80105928:	e8 e3 e9 ff ff       	call   80104310 <acquire>
      ticks++;
      wakeup(&ticks);
...
80105934:	83 05 a0 54 11 80 01 	addl   $0x1,0x801154a0
      wakeup(&ticks);
8010593b:	e8 90 e5 ff ff       	call   80103ed0 <wakeup>
      release(&tickslock);
80105940:	c7 04 24 60 4c 11 80 	movl   $0x80114c60,(%esp)
80105947:	e8 74 ea ff ff       	call   801043c0 <release>
8010594c:	83 c4 10             	add    $0x10,%esp
8010594f:	e9 21 ff ff ff       	jmp    80105875 <trap+0x185>
...
8010595a:	e8 f1 dd ff ff       	call   80103750 <cpuid>
...
80105968:	68 c8 76 10 80       	push   $0x801076c8
8010596d:	e8 ee ac ff ff       	call   80100660 <cprintf>
              tf->trapno, cpuid(), tf->eip, rcr2());
      panic("trap");
80105972:	83 c4 14             	add    $0x14,%esp
80105975:	68 9e 76 10 80       	push   $0x8010769e
...
801059d5:	e8 46 cd ff ff       	call   80102720 <microdelay>
{
  int i;
...
80105a6f:	bb 08 78 10 80       	mov    $0x80107808,%ebx
80105a74:	6a 00                	push   $0x0
80105a76:	6a 04                	push   $0x4
80105a78:	e8 13 c8 ff ff       	call   80102290 <ioapicenable>
...
80105b07:	6a 00                	push   $0x0
  jmp alltraps
80105b09:	e9 ec fa ff ff       	jmp    801055fa <alltraps>
...
80105b10:	6a 01                	push   $0x1
  jmp alltraps
80105b12:	e9 e3 fa ff ff       	jmp    801055fa <alltraps>
...
80105b19:	6a 02                	push   $0x2
  jmp alltraps
80105b1b:	e9 da fa ff ff       	jmp    801055fa <alltraps>
...
80105b2b:	6a 04                	push   $0x4
  jmp alltraps
80105b2d:	e9 c8 fa ff ff       	jmp    801055fa <alltraps>
...
80105b34:	6a 05                	push   $0x5
  jmp alltraps
80105b36:	e9 bf fa ff ff       	jmp    801055fa <alltraps>
...
80105b3d:	6a 06                	push   $0x6
  jmp alltraps
80105b3f:	e9 b6 fa ff ff       	jmp    801055fa <alltraps>
...
80105b46:	6a 07                	push   $0x7
  jmp alltraps
80105b48:	e9 ad fa ff ff       	jmp    801055fa <alltraps>
...
80105b4d:	6a 08                	push   $0x8
  jmp alltraps
80105b4f:	e9 a6 fa ff ff       	jmp    801055fa <alltraps>
...
80105b56:	6a 09                	push   $0x9
  jmp alltraps
80105b58:	e9 9d fa ff ff       	jmp    801055fa <alltraps>
...
80105b64:	6a 0b                	push   $0xb
  jmp alltraps
80105b66:	e9 8f fa ff ff       	jmp    801055fa <alltraps>
...
80105b6b:	6a 0c                	push   $0xc
  jmp alltraps
80105b6d:	e9 88 fa ff ff       	jmp    801055fa <alltraps>
...
80105b72:	6a 0d                	push   $0xd
  jmp alltraps
80105b74:	e9 81 fa ff ff       	jmp    801055fa <alltraps>
...
80105b79:	6a 0e                	push   $0xe
  jmp alltraps
80105b7b:	e9 7a fa ff ff       	jmp    801055fa <alltraps>
...
80105b82:	6a 0f                	push   $0xf
  jmp alltraps
80105b84:	e9 71 fa ff ff       	jmp    801055fa <alltraps>
...
80105b8b:	6a 10                	push   $0x10
  jmp alltraps
80105b8d:	e9 68 fa ff ff       	jmp    801055fa <alltraps>
...
80105b92:	6a 11                	push   $0x11
  jmp alltraps
80105b94:	e9 61 fa ff ff       	jmp    801055fa <alltraps>
...
80105b9b:	6a 12                	push   $0x12
  jmp alltraps
80105b9d:	e9 58 fa ff ff       	jmp    801055fa <alltraps>
...
80105ba4:	6a 13                	push   $0x13
  jmp alltraps
80105ba6:	e9 4f fa ff ff       	jmp    801055fa <alltraps>
...
80105bad:	6a 14                	push   $0x14
  jmp alltraps
80105baf:	e9 46 fa ff ff       	jmp    801055fa <alltraps>
...
80105bb6:	6a 15                	push   $0x15
  jmp alltraps
80105bb8:	e9 3d fa ff ff       	jmp    801055fa <alltraps>
...
80105bbf:	6a 16                	push   $0x16
  jmp alltraps
80105bc1:	e9 34 fa ff ff       	jmp    801055fa <alltraps>
...
80105bc8:	6a 17                	push   $0x17
  jmp alltraps
80105bca:	e9 2b fa ff ff       	jmp    801055fa <alltraps>
...
80105bd1:	6a 18                	push   $0x18
  jmp alltraps
80105bd3:	e9 22 fa ff ff       	jmp    801055fa <alltraps>
...
80105bda:	6a 19                	push   $0x19
  jmp alltraps
80105bdc:	e9 19 fa ff ff       	jmp    801055fa <alltraps>
...
80105be3:	6a 1a                	push   $0x1a
  jmp alltraps
80105be5:	e9 10 fa ff ff       	jmp    801055fa <alltraps>
...
80105bec:	6a 1b                	push   $0x1b
  jmp alltraps
80105bee:	e9 07 fa ff ff       	jmp    801055fa <alltraps>
...
80105bf5:	6a 1c                	push   $0x1c
  jmp alltraps
80105bf7:	e9 fe f9 ff ff       	jmp    801055fa <alltraps>
...
80105bfe:	6a 1d                	push   $0x1d
  jmp alltraps
80105c00:	e9 f5 f9 ff ff       	jmp    801055fa <alltraps>
...
80105c07:	6a 1e                	push   $0x1e
  jmp alltraps
80105c09:	e9 ec f9 ff ff       	jmp    801055fa <alltraps>
...
80105c10:	6a 1f                	push   $0x1f
  jmp alltraps
80105c12:	e9 e3 f9 ff ff       	jmp    801055fa <alltraps>
...
80105c19:	6a 20                	push   $0x20
  jmp alltraps
80105c1b:	e9 da f9 ff ff       	jmp    801055fa <alltraps>
...
80105c22:	6a 21                	push   $0x21
  jmp alltraps
80105c24:	e9 d1 f9 ff ff       	jmp    801055fa <alltraps>
...
80105c2b:	6a 22                	push   $0x22
  jmp alltraps
80105c2d:	e9 c8 f9 ff ff       	jmp    801055fa <alltraps>
...
80105c34:	6a 23                	push   $0x23
  jmp alltraps
80105c36:	e9 bf f9 ff ff       	jmp    801055fa <alltraps>
...
80105c3d:	6a 24                	push   $0x24
  jmp alltraps
80105c3f:	e9 b6 f9 ff ff       	jmp    801055fa <alltraps>
...
80105c46:	6a 25                	push   $0x25
  jmp alltraps
80105c48:	e9 ad f9 ff ff       	jmp    801055fa <alltraps>
...
80105c4f:	6a 26                	push   $0x26
  jmp alltraps
80105c51:	e9 a4 f9 ff ff       	jmp    801055fa <alltraps>
...
80105c58:	6a 27                	push   $0x27
  jmp alltraps
80105c5a:	e9 9b f9 ff ff       	jmp    801055fa <alltraps>
...
80105c61:	6a 28                	push   $0x28
  jmp alltraps
80105c63:	e9 92 f9 ff ff       	jmp    801055fa <alltraps>
...
80105c6a:	6a 29                	push   $0x29
  jmp alltraps
80105c6c:	e9 89 f9 ff ff       	jmp    801055fa <alltraps>
...
80105c73:	6a 2a                	push   $0x2a
  jmp alltraps
80105c75:	e9 80 f9 ff ff       	jmp    801055fa <alltraps>
...
80105c7c:	6a 2b                	push   $0x2b
  jmp alltraps
80105c7e:	e9 77 f9 ff ff       	jmp    801055fa <alltraps>
...
80105c85:	6a 2c                	push   $0x2c
  jmp alltraps
80105c87:	e9 6e f9 ff ff       	jmp    801055fa <alltraps>
...
80105c8e:	6a 2d                	push   $0x2d
  jmp alltraps
80105c90:	e9 65 f9 ff ff       	jmp    801055fa <alltraps>
...
80105c97:	6a 2e                	push   $0x2e
  jmp alltraps
80105c99:	e9 5c f9 ff ff       	jmp    801055fa <alltraps>
...
80105ca0:	6a 2f                	push   $0x2f
  jmp alltraps
80105ca2:	e9 53 f9 ff ff       	jmp    801055fa <alltraps>
...
80105ca9:	6a 30                	push   $0x30
  jmp alltraps
80105cab:	e9 4a f9 ff ff       	jmp    801055fa <alltraps>
...
80105cb2:	6a 31                	push   $0x31
  jmp alltraps
80105cb4:	e9 41 f9 ff ff       	jmp    801055fa <alltraps>
...
80105cbb:	6a 32                	push   $0x32
  jmp alltraps
80105cbd:	e9 38 f9 ff ff       	jmp    801055fa <alltraps>
...
80105cc4:	6a 33                	push   $0x33
  jmp alltraps
80105cc6:	e9 2f f9 ff ff       	jmp    801055fa <alltraps>
...
80105ccd:	6a 34                	push   $0x34
  jmp alltraps
80105ccf:	e9 26 f9 ff ff       	jmp    801055fa <alltraps>
...
80105cd6:	6a 35                	push   $0x35
  jmp alltraps
80105cd8:	e9 1d f9 ff ff       	jmp    801055fa <alltraps>
...
80105cdf:	6a 36                	push   $0x36
  jmp alltraps
80105ce1:	e9 14 f9 ff ff       	jmp    801055fa <alltraps>
...
80105ce8:	6a 37                	push   $0x37
  jmp alltraps
80105cea:	e9 0b f9 ff ff       	jmp    801055fa <alltraps>
...
80105cf1:	6a 38                	push   $0x38
  jmp alltraps
80105cf3:	e9 02 f9 ff ff       	jmp    801055fa <alltraps>
...
80105cfa:	6a 39                	push   $0x39
  jmp alltraps
80105cfc:	e9 f9 f8 ff ff       	jmp    801055fa <alltraps>
...
80105d03:	6a 3a                	push   $0x3a
  jmp alltraps
80105d05:	e9 f0 f8 ff ff       	jmp    801055fa <alltraps>
...
80105d0c:	6a 3b                	push   $0x3b
  jmp alltraps
80105d0e:	e9 e7 f8 ff ff       	jmp    801055fa <alltraps>
...
80105d15:	6a 3c                	push   $0x3c
  jmp alltraps
80105d17:	e9 de f8 ff ff       	jmp    801055fa <alltraps>
...
80105d1e:	6a 3d                	push   $0x3d
  jmp alltraps
80105d20:	e9 d5 f8 ff ff       	jmp    801055fa <alltraps>
...
80105d27:	6a 3e                	push   $0x3e
  jmp alltraps
80105d29:	e9 cc f8 ff ff       	jmp    801055fa <alltraps>
...
80105d30:	6a 3f                	push   $0x3f
  jmp alltraps
80105d32:	e9 c3 f8 ff ff       	jmp    801055fa <alltraps>
...
80105d39:	6a 40                	push   $0x40
  jmp alltraps
80105d3b:	e9 ba f8 ff ff       	jmp    801055fa <alltraps>
...
80105d42:	6a 41                	push   $0x41
  jmp alltraps
80105d44:	e9 b1 f8 ff ff       	jmp    801055fa <alltraps>
...
80105d4b:	6a 42                	push   $0x42
  jmp alltraps
80105d4d:	e9 a8 f8 ff ff       	jmp    801055fa <alltraps>
...
80105d54:	6a 43                	push   $0x43
  jmp alltraps
80105d56:	e9 9f f8 ff ff       	jmp    801055fa <alltraps>
...
80105d5d:	6a 44                	push   $0x44
  jmp alltraps
80105d5f:	e9 96 f8 ff ff       	jmp    801055fa <alltraps>
...
80105d66:	6a 45                	push   $0x45
  jmp alltraps
80105d68:	e9 8d f8 ff ff       	jmp    801055fa <alltraps>
...
80105d6f:	6a 46                	push   $0x46
  jmp alltraps
80105d71:	e9 84 f8 ff ff       	jmp    801055fa <alltraps>
...
80105d78:	6a 47                	push   $0x47
  jmp alltraps
80105d7a:	e9 7b f8 ff ff       	jmp    801055fa <alltraps>
...
80105d81:	6a 48                	push   $0x48
  jmp alltraps
80105d83:	e9 72 f8 ff ff       	jmp    801055fa <alltraps>
...
80105d8a:	6a 49                	push   $0x49
  jmp alltraps
80105d8c:	e9 69 f8 ff ff       	jmp    801055fa <alltraps>
...
80105d93:	6a 4a                	push   $0x4a
  jmp alltraps
80105d95:	e9 60 f8 ff ff       	jmp    801055fa <alltraps>
...
80105d9c:	6a 4b                	push   $0x4b
  jmp alltraps
80105d9e:	e9 57 f8 ff ff       	jmp    801055fa <alltraps>
...
80105da5:	6a 4c                	push   $0x4c
  jmp alltraps
80105da7:	e9 4e f8 ff ff       	jmp    801055fa <alltraps>
...
80105dae:	6a 4d                	push   $0x4d
  jmp alltraps
80105db0:	e9 45 f8 ff ff       	jmp    801055fa <alltraps>
...
80105db7:	6a 4e                	push   $0x4e
  jmp alltraps
80105db9:	e9 3c f8 ff ff       	jmp    801055fa <alltraps>
...
80105dc0:	6a 4f                	push   $0x4f
  jmp alltraps
80105dc2:	e9 33 f8 ff ff       	jmp    801055fa <alltraps>
...
80105dc9:	6a 50                	push   $0x50
  jmp alltraps
80105dcb:	e9 2a f8 ff ff       	jmp    801055fa <alltraps>
...
80105dd2:	6a 51                	push   $0x51
  jmp alltraps
80105dd4:	e9 21 f8 ff ff       	jmp    801055fa <alltraps>
...
80105ddb:	6a 52                	push   $0x52
  jmp alltraps
80105ddd:	e9 18 f8 ff ff       	jmp    801055fa <alltraps>
...
80105de4:	6a 53                	push   $0x53
  jmp alltraps
80105de6:	e9 0f f8 ff ff       	jmp    801055fa <alltraps>
...
80105ded:	6a 54                	push   $0x54
  jmp alltraps
80105def:	e9 06 f8 ff ff       	jmp    801055fa <alltraps>
...
80105df6:	6a 55                	push   $0x55
  jmp alltraps
80105df8:	e9 fd f7 ff ff       	jmp    801055fa <alltraps>
...
80105dff:	6a 56                	push   $0x56
  jmp alltraps
80105e01:	e9 f4 f7 ff ff       	jmp    801055fa <alltraps>
...
80105e08:	6a 57                	push   $0x57
  jmp alltraps
80105e0a:	e9 eb f7 ff ff       	jmp    801055fa <alltraps>
...
80105e11:	6a 58                	push   $0x58
  jmp alltraps
80105e13:	e9 e2 f7 ff ff       	jmp    801055fa <alltraps>
...
80105e1a:	6a 59                	push   $0x59
  jmp alltraps
80105e1c:	e9 d9 f7 ff ff       	jmp    801055fa <alltraps>
...
80105e23:	6a 5a                	push   $0x5a
  jmp alltraps
80105e25:	e9 d0 f7 ff ff       	jmp    801055fa <alltraps>
...
80105e2c:	6a 5b                	push   $0x5b
  jmp alltraps
80105e2e:	e9 c7 f7 ff ff       	jmp    801055fa <alltraps>
...
80105e35:	6a 5c                	push   $0x5c
  jmp alltraps
80105e37:	e9 be f7 ff ff       	jmp    801055fa <alltraps>
...
80105e3e:	6a 5d                	push   $0x5d
  jmp alltraps
80105e40:	e9 b5 f7 ff ff       	jmp    801055fa <alltraps>
...
80105e47:	6a 5e                	push   $0x5e
  jmp alltraps
80105e49:	e9 ac f7 ff ff       	jmp    801055fa <alltraps>
...
80105e50:	6a 5f                	push   $0x5f
  jmp alltraps
80105e52:	e9 a3 f7 ff ff       	jmp    801055fa <alltraps>
...
80105e59:	6a 60                	push   $0x60
  jmp alltraps
80105e5b:	e9 9a f7 ff ff       	jmp    801055fa <alltraps>
...
80105e62:	6a 61                	push   $0x61
  jmp alltraps
80105e64:	e9 91 f7 ff ff       	jmp    801055fa <alltraps>
...
80105e6b:	6a 62                	push   $0x62
  jmp alltraps
80105e6d:	e9 88 f7 ff ff       	jmp    801055fa <alltraps>
...
80105e74:	6a 63                	push   $0x63
  jmp alltraps
80105e76:	e9 7f f7 ff ff       	jmp    801055fa <alltraps>
...
80105e7d:	6a 64                	push   $0x64
  jmp alltraps
80105e7f:	e9 76 f7 ff ff       	jmp    801055fa <alltraps>
...
80105e86:	6a 65                	push   $0x65
  jmp alltraps
80105e88:	e9 6d f7 ff ff       	jmp    801055fa <alltraps>
...
80105e8f:	6a 66                	push   $0x66
  jmp alltraps
80105e91:	e9 64 f7 ff ff       	jmp    801055fa <alltraps>
...
80105e98:	6a 67                	push   $0x67
  jmp alltraps
80105e9a:	e9 5b f7 ff ff       	jmp    801055fa <alltraps>
...
80105ea1:	6a 68                	push   $0x68
  jmp alltraps
80105ea3:	e9 52 f7 ff ff       	jmp    801055fa <alltraps>
...
80105eaa:	6a 69                	push   $0x69
  jmp alltraps
80105eac:	e9 49 f7 ff ff       	jmp    801055fa <alltraps>
...
80105eb3:	6a 6a                	push   $0x6a
  jmp alltraps
80105eb5:	e9 40 f7 ff ff       	jmp    801055fa <alltraps>
...
80105ebc:	6a 6b                	push   $0x6b
  jmp alltraps
80105ebe:	e9 37 f7 ff ff       	jmp    801055fa <alltraps>
...
80105ec5:	6a 6c                	push   $0x6c
  jmp alltraps
80105ec7:	e9 2e f7 ff ff       	jmp    801055fa <alltraps>
...
80105ece:	6a 6d                	push   $0x6d
  jmp alltraps
80105ed0:	e9 25 f7 ff ff       	jmp    801055fa <alltraps>
...
80105ed7:	6a 6e                	push   $0x6e
  jmp alltraps
80105ed9:	e9 1c f7 ff ff       	jmp    801055fa <alltraps>
...
80105ee0:	6a 6f                	push   $0x6f
  jmp alltraps
80105ee2:	e9 13 f7 ff ff       	jmp    801055fa <alltraps>
...
80105ee9:	6a 70                	push   $0x70
  jmp alltraps
80105eeb:	e9 0a f7 ff ff       	jmp    801055fa <alltraps>
...
80105ef2:	6a 71                	push   $0x71
  jmp alltraps
80105ef4:	e9 01 f7 ff ff       	jmp    801055fa <alltraps>
...
80105efb:	6a 72                	push   $0x72
  jmp alltraps
80105efd:	e9 f8 f6 ff ff       	jmp    801055fa <alltraps>
...
80105f04:	6a 73                	push   $0x73
  jmp alltraps
80105f06:	e9 ef f6 ff ff       	jmp    801055fa <alltraps>
...
80105f0d:	6a 74                	push   $0x74
  jmp alltraps
80105f0f:	e9 e6 f6 ff ff       	jmp    801055fa <alltraps>
...
80105f16:	6a 75                	push   $0x75
  jmp alltraps
80105f18:	e9 dd f6 ff ff       	jmp    801055fa <alltraps>
...
80105f1f:	6a 76                	push   $0x76
  jmp alltraps
80105f21:	e9 d4 f6 ff ff       	jmp    801055fa <alltraps>
...
80105f28:	6a 77                	push   $0x77
  jmp alltraps
80105f2a:	e9 cb f6 ff ff       	jmp    801055fa <alltraps>
...
80105f31:	6a 78                	push   $0x78
  jmp alltraps
80105f33:	e9 c2 f6 ff ff       	jmp    801055fa <alltraps>
...
80105f3a:	6a 79                	push   $0x79
  jmp alltraps
80105f3c:	e9 b9 f6 ff ff       	jmp    801055fa <alltraps>
...
80105f43:	6a 7a                	push   $0x7a
  jmp alltraps
80105f45:	e9 b0 f6 ff ff       	jmp    801055fa <alltraps>
...
80105f4c:	6a 7b                	push   $0x7b
  jmp alltraps
80105f4e:	e9 a7 f6 ff ff       	jmp    801055fa <alltraps>
...
80105f55:	6a 7c                	push   $0x7c
  jmp alltraps
80105f57:	e9 9e f6 ff ff       	jmp    801055fa <alltraps>
...
80105f5e:	6a 7d                	push   $0x7d
  jmp alltraps
80105f60:	e9 95 f6 ff ff       	jmp    801055fa <alltraps>
...
80105f67:	6a 7e                	push   $0x7e
  jmp alltraps
80105f69:	e9 8c f6 ff ff       	jmp    801055fa <alltraps>
...
80105f70:	6a 7f                	push   $0x7f
  jmp alltraps
80105f72:	e9 83 f6 ff ff       	jmp    801055fa <alltraps>
...
80105f79:	68 80 00 00 00       	push   $0x80
  jmp alltraps
80105f7e:	e9 77 f6 ff ff       	jmp    801055fa <alltraps>
...
80105f85:	68 81 00 00 00       	push   $0x81
  jmp alltraps
80105f8a:	e9 6b f6 ff ff       	jmp    801055fa <alltraps>
...
80105f91:	68 82 00 00 00       	push   $0x82
  jmp alltraps
80105f96:	e9 5f f6 ff ff       	jmp    801055fa <alltraps>
...
80105f9d:	68 83 00 00 00       	push   $0x83
  jmp alltraps
80105fa2:	e9 53 f6 ff ff       	jmp    801055fa <alltraps>
...
80105fa9:	68 84 00 00 00       	push   $0x84
  jmp alltraps
80105fae:	e9 47 f6 ff ff       	jmp    801055fa <alltraps>
...
80105fb5:	68 85 00 00 00       	push   $0x85
  jmp alltraps
80105fba:	e9 3b f6 ff ff       	jmp    801055fa <alltraps>
...
80105fc1:	68 86 00 00 00       	push   $0x86
  jmp alltraps
80105fc6:	e9 2f f6 ff ff       	jmp    801055fa <alltraps>
...
80105fcd:	68 87 00 00 00       	push   $0x87
  jmp alltraps
80105fd2:	e9 23 f6 ff ff       	jmp    801055fa <alltraps>
...
80105fd9:	68 88 00 00 00       	push   $0x88
  jmp alltraps
80105fde:	e9 17 f6 ff ff       	jmp    801055fa <alltraps>
...
80105fe5:	68 89 00 00 00       	push   $0x89
  jmp alltraps
80105fea:	e9 0b f6 ff ff       	jmp    801055fa <alltraps>
...
80105ff1:	68 8a 00 00 00       	push   $0x8a
  jmp alltraps
80105ff6:	e9 ff f5 ff ff       	jmp    801055fa <alltraps>
...
80105ffd:	68 8b 00 00 00       	push   $0x8b
  jmp alltraps
80106002:	e9 f3 f5 ff ff       	jmp    801055fa <alltraps>
...
80106009:	68 8c 00 00 00       	push   $0x8c
  jmp alltraps
8010600e:	e9 e7 f5 ff ff       	jmp    801055fa <alltraps>
...
80106015:	68 8d 00 00 00       	push   $0x8d
  jmp alltraps
8010601a:	e9 db f5 ff ff       	jmp    801055fa <alltraps>
...
80106021:	68 8e 00 00 00       	push   $0x8e
  jmp alltraps
80106026:	e9 cf f5 ff ff       	jmp    801055fa <alltraps>
...
8010602d:	68 8f 00 00 00       	push   $0x8f
  jmp alltraps
80106032:	e9 c3 f5 ff ff       	jmp    801055fa <alltraps>
...
80106039:	68 90 00 00 00       	push   $0x90
  jmp alltraps
8010603e:	e9 b7 f5 ff ff       	jmp    801055fa <alltraps>
...
80106045:	68 91 00 00 00       	push   $0x91
  jmp alltraps
8010604a:	e9 ab f5 ff ff       	jmp    801055fa <alltraps>
...
80106051:	68 92 00 00 00       	push   $0x92
  jmp alltraps
80106056:	e9 9f f5 ff ff       	jmp    801055fa <alltraps>
...
8010605d:	68 93 00 00 00       	push   $0x93
  jmp alltraps
80106062:	e9 93 f5 ff ff       	jmp    801055fa <alltraps>
...
80106069:	68 94 00 00 00       	push   $0x94
  jmp alltraps
8010606e:	e9 87 f5 ff ff       	jmp    801055fa <alltraps>
...
80106075:	68 95 00 00 00       	push   $0x95
  jmp alltraps
8010607a:	e9 7b f5 ff ff       	jmp    801055fa <alltraps>
...
80106081:	68 96 00 00 00       	push   $0x96
  jmp alltraps
80106086:	e9 6f f5 ff ff       	jmp    801055fa <alltraps>
...
8010608d:	68 97 00 00 00       	push   $0x97
  jmp alltraps
80106092:	e9 63 f5 ff ff       	jmp    801055fa <alltraps>
...
80106099:	68 98 00 00 00       	push   $0x98
  jmp alltraps
8010609e:	e9 57 f5 ff ff       	jmp    801055fa <alltraps>
...
801060a5:	68 99 00 00 00       	push   $0x99
  jmp alltraps
801060aa:	e9 4b f5 ff ff       	jmp    801055fa <alltraps>
...
801060b1:	68 9a 00 00 00       	push   $0x9a
  jmp alltraps
801060b6:	e9 3f f5 ff ff       	jmp    801055fa <alltraps>
...
801060bd:	68 9b 00 00 00       	push   $0x9b
  jmp alltraps
801060c2:	e9 33 f5 ff ff       	jmp    801055fa <alltraps>
...
801060c9:	68 9c 00 00 00       	push   $0x9c
  jmp alltraps
801060ce:	e9 27 f5 ff ff       	jmp    801055fa <alltraps>
...
801060d5:	68 9d 00 00 00       	push   $0x9d
  jmp alltraps
801060da:	e9 1b f5 ff ff       	jmp    801055fa <alltraps>
...
801060e1:	68 9e 00 00 00       	push   $0x9e
  jmp alltraps
801060e6:	e9 0f f5 ff ff       	jmp    801055fa <alltraps>
...
801060ed:	68 9f 00 00 00       	push   $0x9f
  jmp alltraps
801060f2:	e9 03 f5 ff ff       	jmp    801055fa <alltraps>
...
801060f9:	68 a0 00 00 00       	push   $0xa0
  jmp alltraps
801060fe:	e9 f7 f4 ff ff       	jmp    801055fa <alltraps>
...
80106105:	68 a1 00 00 00       	push   $0xa1
  jmp alltraps
8010610a:	e9 eb f4 ff ff       	jmp    801055fa <alltraps>
...
80106111:	68 a2 00 00 00       	push   $0xa2
  jmp alltraps
80106116:	e9 df f4 ff ff       	jmp    801055fa <alltraps>
...
8010611d:	68 a3 00 00 00       	push   $0xa3
  jmp alltraps
80106122:	e9 d3 f4 ff ff       	jmp    801055fa <alltraps>
...
80106129:	68 a4 00 00 00       	push   $0xa4
  jmp alltraps
8010612e:	e9 c7 f4 ff ff       	jmp    801055fa <alltraps>
...
80106135:	68 a5 00 00 00       	push   $0xa5
  jmp alltraps
8010613a:	e9 bb f4 ff ff       	jmp    801055fa <alltraps>
...
80106141:	68 a6 00 00 00       	push   $0xa6
  jmp alltraps
80106146:	e9 af f4 ff ff       	jmp    801055fa <alltraps>
...
8010614d:	68 a7 00 00 00       	push   $0xa7
  jmp alltraps
80106152:	e9 a3 f4 ff ff       	jmp    801055fa <alltraps>
...
80106159:	68 a8 00 00 00       	push   $0xa8
  jmp alltraps
8010615e:	e9 97 f4 ff ff       	jmp    801055fa <alltraps>
...
80106165:	68 a9 00 00 00       	push   $0xa9
  jmp alltraps
8010616a:	e9 8b f4 ff ff       	jmp    801055fa <alltraps>
...
80106171:	68 aa 00 00 00       	push   $0xaa
  jmp alltraps
80106176:	e9 7f f4 ff ff       	jmp    801055fa <alltraps>
...
8010617d:	68 ab 00 00 00       	push   $0xab
  jmp alltraps
80106182:	e9 73 f4 ff ff       	jmp    801055fa <alltraps>
...
80106189:	68 ac 00 00 00       	push   $0xac
  jmp alltraps
8010618e:	e9 67 f4 ff ff       	jmp    801055fa <alltraps>
...
80106195:	68 ad 00 00 00       	push   $0xad
  jmp alltraps
8010619a:	e9 5b f4 ff ff       	jmp    801055fa <alltraps>
...
801061a1:	68 ae 00 00 00       	push   $0xae
  jmp alltraps
801061a6:	e9 4f f4 ff ff       	jmp    801055fa <alltraps>
...
801061ad:	68 af 00 00 00       	push   $0xaf
  jmp alltraps
801061b2:	e9 43 f4 ff ff       	jmp    801055fa <alltraps>
...
801061b9:	68 b0 00 00 00       	push   $0xb0
  jmp alltraps
801061be:	e9 37 f4 ff ff       	jmp    801055fa <alltraps>
...
801061c5:	68 b1 00 00 00       	push   $0xb1
  jmp alltraps
801061ca:	e9 2b f4 ff ff       	jmp    801055fa <alltraps>
...
801061d1:	68 b2 00 00 00       	push   $0xb2
  jmp alltraps
801061d6:	e9 1f f4 ff ff       	jmp    801055fa <alltraps>
...
801061dd:	68 b3 00 00 00       	push   $0xb3
  jmp alltraps
801061e2:	e9 13 f4 ff ff       	jmp    801055fa <alltraps>
...
801061e9:	68 b4 00 00 00       	push   $0xb4
  jmp alltraps
801061ee:	e9 07 f4 ff ff       	jmp    801055fa <alltraps>
...
801061f5:	68 b5 00 00 00       	push   $0xb5
  jmp alltraps
801061fa:	e9 fb f3 ff ff       	jmp    801055fa <alltraps>
...
80106201:	68 b6 00 00 00       	push   $0xb6
  jmp alltraps
80106206:	e9 ef f3 ff ff       	jmp    801055fa <alltraps>
...
8010620d:	68 b7 00 00 00       	push   $0xb7
  jmp alltraps
80106212:	e9 e3 f3 ff ff       	jmp    801055fa <alltraps>
...
80106219:	68 b8 00 00 00       	push   $0xb8
  jmp alltraps
8010621e:	e9 d7 f3 ff ff       	jmp    801055fa <alltraps>
...
80106225:	68 b9 00 00 00       	push   $0xb9
  jmp alltraps
8010622a:	e9 cb f3 ff ff       	jmp    801055fa <alltraps>
...
80106231:	68 ba 00 00 00       	push   $0xba
  jmp alltraps
80106236:	e9 bf f3 ff ff       	jmp    801055fa <alltraps>
...
8010623d:	68 bb 00 00 00       	push   $0xbb
  jmp alltraps
80106242:	e9 b3 f3 ff ff       	jmp    801055fa <alltraps>
...
80106249:	68 bc 00 00 00       	push   $0xbc
  jmp alltraps
8010624e:	e9 a7 f3 ff ff       	jmp    801055fa <alltraps>
...
80106255:	68 bd 00 00 00       	push   $0xbd
  jmp alltraps
8010625a:	e9 9b f3 ff ff       	jmp    801055fa <alltraps>
...
80106261:	68 be 00 00 00       	push   $0xbe
  jmp alltraps
80106266:	e9 8f f3 ff ff       	jmp    801055fa <alltraps>
...
8010626d:	68 bf 00 00 00       	push   $0xbf
  jmp alltraps
80106272:	e9 83 f3 ff ff       	jmp    801055fa <alltraps>
...
80106279:	68 c0 00 00 00       	push   $0xc0
  jmp alltraps
8010627e:	e9 77 f3 ff ff       	jmp    801055fa <alltraps>
...
80106285:	68 c1 00 00 00       	push   $0xc1
  jmp alltraps
8010628a:	e9 6b f3 ff ff       	jmp    801055fa <alltraps>
...
80106291:	68 c2 00 00 00       	push   $0xc2
  jmp alltraps
80106296:	e9 5f f3 ff ff       	jmp    801055fa <alltraps>
...
8010629d:	68 c3 00 00 00       	push   $0xc3
  jmp alltraps
801062a2:	e9 53 f3 ff ff       	jmp    801055fa <alltraps>
...
801062a9:	68 c4 00 00 00       	push   $0xc4
  jmp alltraps
801062ae:	e9 47 f3 ff ff       	jmp    801055fa <alltraps>
...
801062b5:	68 c5 00 00 00       	push   $0xc5
  jmp alltraps
801062ba:	e9 3b f3 ff ff       	jmp    801055fa <alltraps>
...
801062c1:	68 c6 00 00 00       	push   $0xc6
  jmp alltraps
801062c6:	e9 2f f3 ff ff       	jmp    801055fa <alltraps>
...
801062cd:	68 c7 00 00 00       	push   $0xc7
  jmp alltraps
801062d2:	e9 23 f3 ff ff       	jmp    801055fa <alltraps>
...
801062d9:	68 c8 00 00 00       	push   $0xc8
  jmp alltraps
801062de:	e9 17 f3 ff ff       	jmp    801055fa <alltraps>
...
801062e5:	68 c9 00 00 00       	push   $0xc9
  jmp alltraps
801062ea:	e9 0b f3 ff ff       	jmp    801055fa <alltraps>
...
801062f1:	68 ca 00 00 00       	push   $0xca
  jmp alltraps
801062f6:	e9 ff f2 ff ff       	jmp    801055fa <alltraps>
...
801062fd:	68 cb 00 00 00       	push   $0xcb
  jmp alltraps
80106302:	e9 f3 f2 ff ff       	jmp    801055fa <alltraps>
...
80106309:	68 cc 00 00 00       	push   $0xcc
  jmp alltraps
8010630e:	e9 e7 f2 ff ff       	jmp    801055fa <alltraps>
...
80106315:	68 cd 00 00 00       	push   $0xcd
  jmp alltraps
8010631a:	e9 db f2 ff ff       	jmp    801055fa <alltraps>
...
80106321:	68 ce 00 00 00       	push   $0xce
  jmp alltraps
80106326:	e9 cf f2 ff ff       	jmp    801055fa <alltraps>
...
8010632d:	68 cf 00 00 00       	push   $0xcf
  jmp alltraps
80106332:	e9 c3 f2 ff ff       	jmp    801055fa <alltraps>
...
80106339:	68 d0 00 00 00       	push   $0xd0
  jmp alltraps
8010633e:	e9 b7 f2 ff ff       	jmp    801055fa <alltraps>
...
80106345:	68 d1 00 00 00       	push   $0xd1
  jmp alltraps
8010634a:	e9 ab f2 ff ff       	jmp    801055fa <alltraps>
...
80106351:	68 d2 00 00 00       	push   $0xd2
  jmp alltraps
80106356:	e9 9f f2 ff ff       	jmp    801055fa <alltraps>
...
8010635d:	68 d3 00 00 00       	push   $0xd3
  jmp alltraps
80106362:	e9 93 f2 ff ff       	jmp    801055fa <alltraps>
...
80106369:	68 d4 00 00 00       	push   $0xd4
  jmp alltraps
8010636e:	e9 87 f2 ff ff       	jmp    801055fa <alltraps>
...
80106375:	68 d5 00 00 00       	push   $0xd5
  jmp alltraps
8010637a:	e9 7b f2 ff ff       	jmp    801055fa <alltraps>
...
80106381:	68 d6 00 00 00       	push   $0xd6
  jmp alltraps
80106386:	e9 6f f2 ff ff       	jmp    801055fa <alltraps>
...
8010638d:	68 d7 00 00 00       	push   $0xd7
  jmp alltraps
80106392:	e9 63 f2 ff ff       	jmp    801055fa <alltraps>
...
80106399:	68 d8 00 00 00       	push   $0xd8
  jmp alltraps
8010639e:	e9 57 f2 ff ff       	jmp    801055fa <alltraps>
...
801063a5:	68 d9 00 00 00       	push   $0xd9
  jmp alltraps
801063aa:	e9 4b f2 ff ff       	jmp    801055fa <alltraps>
...
801063b1:	68 da 00 00 00       	push   $0xda
  jmp alltraps
801063b6:	e9 3f f2 ff ff       	jmp    801055fa <alltraps>
...
801063bd:	68 db 00 00 00       	push   $0xdb
  jmp alltraps
801063c2:	e9 33 f2 ff ff       	jmp    801055fa <alltraps>
...
801063c9:	68 dc 00 00 00       	push   $0xdc
  jmp alltraps
801063ce:	e9 27 f2 ff ff       	jmp    801055fa <alltraps>
...
801063d5:	68 dd 00 00 00       	push   $0xdd
  jmp alltraps
801063da:	e9 1b f2 ff ff       	jmp    801055fa <alltraps>
...
801063e1:	68 de 00 00 00       	push   $0xde
  jmp alltraps
801063e6:	e9 0f f2 ff ff       	jmp    801055fa <alltraps>
...
801063ed:	68 df 00 00 00       	push   $0xdf
  jmp alltraps
801063f2:	e9 03 f2 ff ff       	jmp    801055fa <alltraps>
...
801063f9:	68 e0 00 00 00       	push   $0xe0
  jmp alltraps
801063fe:	e9 f7 f1 ff ff       	jmp    801055fa <alltraps>
...
80106405:	68 e1 00 00 00       	push   $0xe1
  jmp alltraps
8010640a:	e9 eb f1 ff ff       	jmp    801055fa <alltraps>
...
80106411:	68 e2 00 00 00       	push   $0xe2
  jmp alltraps
80106416:	e9 df f1 ff ff       	jmp    801055fa <alltraps>
...
8010641d:	68 e3 00 00 00       	push   $0xe3
  jmp alltraps
80106422:	e9 d3 f1 ff ff       	jmp    801055fa <alltraps>
...
80106429:	68 e4 00 00 00       	push   $0xe4
  jmp alltraps
8010642e:	e9 c7 f1 ff ff       	jmp    801055fa <alltraps>
...
80106435:	68 e5 00 00 00       	push   $0xe5
  jmp alltraps
8010643a:	e9 bb f1 ff ff       	jmp    801055fa <alltraps>
...
80106441:	68 e6 00 00 00       	push   $0xe6
  jmp alltraps
80106446:	e9 af f1 ff ff       	jmp    801055fa <alltraps>
...
8010644d:	68 e7 00 00 00       	push   $0xe7
  jmp alltraps
80106452:	e9 a3 f1 ff ff       	jmp    801055fa <alltraps>
...
80106459:	68 e8 00 00 00       	push   $0xe8
  jmp alltraps
8010645e:	e9 97 f1 ff ff       	jmp    801055fa <alltraps>
...
80106465:	68 e9 00 00 00       	push   $0xe9
  jmp alltraps
8010646a:	e9 8b f1 ff ff       	jmp    801055fa <alltraps>
...
80106471:	68 ea 00 00 00       	push   $0xea
  jmp alltraps
80106476:	e9 7f f1 ff ff       	jmp    801055fa <alltraps>
...
8010647d:	68 eb 00 00 00       	push   $0xeb
  jmp alltraps
80106482:	e9 73 f1 ff ff       	jmp    801055fa <alltraps>
...
80106489:	68 ec 00 00 00       	push   $0xec
  jmp alltraps
8010648e:	e9 67 f1 ff ff       	jmp    801055fa <alltraps>
...
80106495:	68 ed 00 00 00       	push   $0xed
  jmp alltraps
8010649a:	e9 5b f1 ff ff       	jmp    801055fa <alltraps>
...
801064a1:	68 ee 00 00 00       	push   $0xee
  jmp alltraps
801064a6:	e9 4f f1 ff ff       	jmp    801055fa <alltraps>
...
801064ad:	68 ef 00 00 00       	push   $0xef
  jmp alltraps
801064b2:	e9 43 f1 ff ff       	jmp    801055fa <alltraps>
...
801064b9:	68 f0 00 00 00       	push   $0xf0
  jmp alltraps
801064be:	e9 37 f1 ff ff       	jmp    801055fa <alltraps>
...
801064c5:	68 f1 00 00 00       	push   $0xf1
  jmp alltraps
801064ca:	e9 2b f1 ff ff       	jmp    801055fa <alltraps>
...
801064d1:	68 f2 00 00 00       	push   $0xf2
  jmp alltraps
801064d6:	e9 1f f1 ff ff       	jmp    801055fa <alltraps>
...
801064dd:	68 f3 00 00 00       	push   $0xf3
  jmp alltraps
801064e2:	e9 13 f1 ff ff       	jmp    801055fa <alltraps>
...
801064e9:	68 f4 00 00 00       	push   $0xf4
  jmp alltraps
801064ee:	e9 07 f1 ff ff       	jmp    801055fa <alltraps>
...
801064f5:	68 f5 00 00 00       	push   $0xf5
  jmp alltraps
801064fa:	e9 fb f0 ff ff       	jmp    801055fa <alltraps>
...
80106501:	68 f6 00 00 00       	push   $0xf6
  jmp alltraps
80106506:	e9 ef f0 ff ff       	jmp    801055fa <alltraps>
...
8010650d:	68 f7 00 00 00       	push   $0xf7
  jmp alltraps
80106512:	e9 e3 f0 ff ff       	jmp    801055fa <alltraps>
...
80106519:	68 f8 00 00 00       	push   $0xf8
  jmp alltraps
8010651e:	e9 d7 f0 ff ff       	jmp    801055fa <alltraps>
...
80106525:	68 f9 00 00 00       	push   $0xf9
  jmp alltraps
8010652a:	e9 cb f0 ff ff       	jmp    801055fa <alltraps>
...
80106531:	68 fa 00 00 00       	push   $0xfa
  jmp alltraps
80106536:	e9 bf f0 ff ff       	jmp    801055fa <alltraps>
...
8010653d:	68 fb 00 00 00       	push   $0xfb
  jmp alltraps
80106542:	e9 b3 f0 ff ff       	jmp    801055fa <alltraps>
...
80106549:	68 fc 00 00 00       	push   $0xfc
  jmp alltraps
8010654e:	e9 a7 f0 ff ff       	jmp    801055fa <alltraps>
...
80106555:	68 fd 00 00 00       	push   $0xfd
  jmp alltraps
8010655a:	e9 9b f0 ff ff       	jmp    801055fa <alltraps>
...
80106561:	68 fe 00 00 00       	push   $0xfe
  jmp alltraps
80106566:	e9 8f f0 ff ff       	jmp    801055fa <alltraps>
...
8010656d:	68 ff 00 00 00       	push   $0xff
  jmp alltraps
80106572:	e9 83 f0 ff ff       	jmp    801055fa <alltraps>
...
801065c4:	e8 b7 be ff ff       	call   80102480 <kalloc>
...
801065da:	e8 31 de ff ff       	call   80104410 <memset>
    // The permissions here are overly generous, but they can
    // be further restricted by the permissions in the page table
    // entries, if necessary.
    *pde = V2P(pgtab) | PTE_P | PTE_W | PTE_U;
...
80106605:	53                   	push   %ebx
  ...
  a = PGROUNDUP(newsz);
80106606:	8d 99 ff 0f 00 00    	lea    0xfff(%ecx),%ebx
// Deallocate user pages to bring the process size from oldsz to
// newsz.  oldsz and newsz need not be page-aligned, nor does newsz
// need to be less than oldsz.  oldsz can be larger than the actual
// process size.  Returns the new process size.
...
int
deallocuvm(pde_t *pgdir, uint oldsz, uint newsz)
80106614:	83 ec 1c             	sub    $0x1c,%esp
80106617:	89 4d e0             	mov    %ecx,-0x20(%ebp)
...
8010661a:	39 d3                	cmp    %edx,%ebx
8010661c:	73 66                	jae    80106684 <deallocuvm.part.0+0x84>
8010661e:	89 d6                	mov    %edx,%esi
80106620:	eb 3d                	jmp    8010665f <deallocuvm.part.0+0x5f>
...
8010662d:	74 26                	je     80106655 <deallocuvm.part.0+0x55>
      pa = PTE_ADDR(*pte);
      if(pa == 0)
8010662f:	81 e2 00 f0 ff ff    	and    $0xfffff000,%edx
80106635:	74 58                	je     8010668f <deallocuvm.part.0+0x8f>
        panic("kfree");
      char *v = P2V(pa);
      kfree(v);
80106637:	83 ec 0c             	sub    $0xc,%esp
8010663a:	81 c2 00 00 00 80    	add    $0x80000000,%edx
80106640:	89 45 e4             	mov    %eax,-0x1c(%ebp)
80106643:	52                   	push   %edx
80106644:	e8 87 bc ff ff       	call   801022d0 <kfree>
      *pte = 0;
80106649:	8b 45 e4             	mov    -0x1c(%ebp),%eax
8010664c:	83 c4 10             	add    $0x10,%esp
8010664f:	c7 00 00 00 00 00    	movl   $0x0,(%eax)
  ...
  a = PGROUNDUP(newsz);
  for(; a  < oldsz; a += PGSIZE){
80106655:	81 c3 00 10 00 00    	add    $0x1000,%ebx
8010665b:	39 f3                	cmp    %esi,%ebx
8010665d:	73 25                	jae    80106684 <deallocuvm.part.0+0x84>
    pte = walkpgdir(pgdir, (char*)a, 0);
8010665f:	31 c9                	xor    %ecx,%ecx
80106661:	89 da                	mov    %ebx,%edx
80106663:	89 f8                	mov    %edi,%eax
80106665:	e8 16 ff ff ff       	call   80106580 <walkpgdir>
    if(!pte)
8010666a:	85 c0                	test   %eax,%eax
8010666c:	75 ba                	jne    80106628 <deallocuvm.part.0+0x28>
      a = PGADDR(PDX(a) + 1, 0, 0) - PGSIZE;
8010666e:	81 e3 00 00 c0 ff    	and    $0xffc00000,%ebx
80106674:	81 c3 00 f0 3f 00    	add    $0x3ff000,%ebx
  ...
  a = PGROUNDUP(newsz);
  for(; a  < oldsz; a += PGSIZE){
8010667a:	81 c3 00 10 00 00    	add    $0x1000,%ebx
80106680:	39 f3                	cmp    %esi,%ebx
80106682:	72 db                	jb     8010665f <deallocuvm.part.0+0x5f>
      kfree(v);
      *pte = 0;
    }
  }
...
80106684:	8b 45 e0             	mov    -0x20(%ebp),%eax
...
80106692:	68 66 71 10 80       	push   $0x80107166
80106697:	e8 d4 9c ff ff       	call   80100370 <panic>
...
801066a3:	83 ec 18             	sub    $0x18,%esp
  ...
  c = &cpus[cpuid()];
801066a6:	e8 a5 d0 ff ff       	call   80103750 <cpuid>
  c->gdt[SEG_KCODE] = SEG(STA_X|STA_R, 0, 0xffffffff, 0);
801066ab:	69 c0 b0 00 00 00    	imul   $0xb0,%eax,%eax
801066b1:	31 c9                	xor    %ecx,%ecx
801066b3:	ba ff ff ff ff       	mov    $0xffffffff,%edx
801066b8:	66 89 90 f8 27 11 80 	mov    %dx,-0x7feed808(%eax)
801066bf:	66 89 88 fa 27 11 80 	mov    %cx,-0x7feed806(%eax)
  c->gdt[SEG_KDATA] = SEG(STA_W, 0, 0xffffffff, 0);
801066c6:	ba ff ff ff ff       	mov    $0xffffffff,%edx
801066cb:	31 c9                	xor    %ecx,%ecx
801066cd:	66 89 90 00 28 11 80 	mov    %dx,-0x7feed800(%eax)
  c->gdt[SEG_UCODE] = SEG(STA_X|STA_R, 0, 0xffffffff, DPL_USER);
801066d4:	ba ff ff ff ff       	mov    $0xffffffff,%edx
  // Cannot share a CODE descriptor for both kernel and user
  // because it would have to have DPL_USR, but the CPU forbids
  // an interrupt from CPL=0 to DPL=3.
  c = &cpus[cpuid()];
  c->gdt[SEG_KCODE] = SEG(STA_X|STA_R, 0, 0xffffffff, 0);
  c->gdt[SEG_KDATA] = SEG(STA_W, 0, 0xffffffff, 0);
801066d9:	66 89 88 02 28 11 80 	mov    %cx,-0x7feed7fe(%eax)
  c->gdt[SEG_UCODE] = SEG(STA_X|STA_R, 0, 0xffffffff, DPL_USER);
801066e0:	31 c9                	xor    %ecx,%ecx
801066e2:	66 89 90 08 28 11 80 	mov    %dx,-0x7feed7f8(%eax)
801066e9:	66 89 88 0a 28 11 80 	mov    %cx,-0x7feed7f6(%eax)
  c->gdt[SEG_UDATA] = SEG(STA_W, 0, 0xffffffff, DPL_USER);
801066f0:	ba ff ff ff ff       	mov    $0xffffffff,%edx
801066f5:	31 c9                	xor    %ecx,%ecx
801066f7:	66 89 90 10 28 11 80 	mov    %dx,-0x7feed7f0(%eax)
  // Map "logical" addresses to virtual addresses using identity map.
  // Cannot share a CODE descriptor for both kernel and user
  // because it would have to have DPL_USR, but the CPU forbids
  // an interrupt from CPL=0 to DPL=3.
  c = &cpus[cpuid()];
  c->gdt[SEG_KCODE] = SEG(STA_X|STA_R, 0, 0xffffffff, 0);
801066fe:	c6 80 fc 27 11 80 00 	movb   $0x0,-0x7feed804(%eax)
static inline void
lgdt(struct segdesc *p, int size)
{
  ...
  pd[0] = size-1;
80106705:	ba 2f 00 00 00       	mov    $0x2f,%edx
8010670a:	c6 80 fd 27 11 80 9a 	movb   $0x9a,-0x7feed803(%eax)
80106711:	c6 80 fe 27 11 80 cf 	movb   $0xcf,-0x7feed802(%eax)
80106718:	c6 80 ff 27 11 80 00 	movb   $0x0,-0x7feed801(%eax)
  c->gdt[SEG_KDATA] = SEG(STA_W, 0, 0xffffffff, 0);
8010671f:	c6 80 04 28 11 80 00 	movb   $0x0,-0x7feed7fc(%eax)
80106726:	c6 80 05 28 11 80 92 	movb   $0x92,-0x7feed7fb(%eax)
8010672d:	c6 80 06 28 11 80 cf 	movb   $0xcf,-0x7feed7fa(%eax)
80106734:	c6 80 07 28 11 80 00 	movb   $0x0,-0x7feed7f9(%eax)
  c->gdt[SEG_UCODE] = SEG(STA_X|STA_R, 0, 0xffffffff, DPL_USER);
8010673b:	c6 80 0c 28 11 80 00 	movb   $0x0,-0x7feed7f4(%eax)
80106742:	c6 80 0d 28 11 80 fa 	movb   $0xfa,-0x7feed7f3(%eax)
80106749:	c6 80 0e 28 11 80 cf 	movb   $0xcf,-0x7feed7f2(%eax)
80106750:	c6 80 0f 28 11 80 00 	movb   $0x0,-0x7feed7f1(%eax)
  c->gdt[SEG_UDATA] = SEG(STA_W, 0, 0xffffffff, DPL_USER);
80106757:	66 89 88 12 28 11 80 	mov    %cx,-0x7feed7ee(%eax)
8010675e:	c6 80 14 28 11 80 00 	movb   $0x0,-0x7feed7ec(%eax)
80106765:	c6 80 15 28 11 80 f2 	movb   $0xf2,-0x7feed7eb(%eax)
8010676c:	c6 80 16 28 11 80 cf 	movb   $0xcf,-0x7feed7ea(%eax)
80106773:	c6 80 17 28 11 80 00 	movb   $0x0,-0x7feed7e9(%eax)
  lgdt(c->gdt, sizeof(c->gdt));
8010677a:	05 f0 27 11 80       	add    $0x801127f0,%eax
8010677f:	66 89 55 f2          	mov    %dx,-0xe(%ebp)
  pd[1] = (uint)p;
80106783:	66 89 45 f4          	mov    %ax,-0xc(%ebp)
  pd[2] = (uint)p >> 16;
80106787:	c1 e8 10             	shr    $0x10,%eax
8010678a:	66 89 45 f6          	mov    %ax,-0xa(%ebp)

  asm volatile("lgdt (%0)" : : "r" (pd));
8010678e:	8d 45 f2             	lea    -0xe(%ebp),%eax
80106791:	0f 01 10             	lgdtl  (%eax)
}
80106794:	c9                   	leave  
80106795:	c3                   	ret    
...
801067ac:	8b 55 10             	mov    0x10(%ebp),%edx
801067af:	8b 7d 14             	mov    0x14(%ebp),%edi
mappages(pde_t *pgdir, void *va, uint size, uint pa, int perm)
{
  char *a, *last;
  pte_t *pte;
...
801067b2:	89 c3                	mov    %eax,%ebx
  last = (char*)PGROUNDDOWN(((uint)va) + size - 1);
801067b4:	8d 44 10 ff          	lea    -0x1(%eax,%edx,1),%eax
mappages(pde_t *pgdir, void *va, uint size, uint pa, int perm)
{
  char *a, *last;
  pte_t *pte;
...
801067b8:	81 e3 00 f0 ff ff    	and    $0xfffff000,%ebx
  last = (char*)PGROUNDDOWN(((uint)va) + size - 1);
801067be:	25 00 f0 ff ff       	and    $0xfffff000,%eax
801067c3:	29 df                	sub    %ebx,%edi
801067c5:	89 45 e4             	mov    %eax,-0x1c(%ebp)
  for(;;){
    ...
    if(*pte & PTE_P)
      panic("remap");
    *pte = pa | perm | PTE_P;
801067c8:	8b 45 18             	mov    0x18(%ebp),%eax
801067cb:	83 c8 01             	or     $0x1,%eax
801067ce:	89 45 e0             	mov    %eax,-0x20(%ebp)
801067d1:	eb 1a                	jmp    801067ed <mappages+0x4d>
801067d3:	90                   	nop
801067d4:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
  ...
  for(;;){
    if((pte = walkpgdir(pgdir, a, 1)) == 0)
      return -1;
    if(*pte & PTE_P)
801067d8:	f6 00 01             	testb  $0x1,(%eax)
801067db:	75 3d                	jne    8010681a <mappages+0x7a>
      panic("remap");
    *pte = pa | perm | PTE_P;
801067dd:	0b 75 e0             	or     -0x20(%ebp),%esi
    if(a == last)
801067e0:	3b 5d e4             	cmp    -0x1c(%ebp),%ebx
  for(;;){
    if((pte = walkpgdir(pgdir, a, 1)) == 0)
      return -1;
    if(*pte & PTE_P)
      panic("remap");
    *pte = pa | perm | PTE_P;
801067e3:	89 30                	mov    %esi,(%eax)
    if(a == last)
801067e5:	74 29                	je     80106810 <mappages+0x70>
      break;
    a += PGSIZE;
801067e7:	81 c3 00 10 00 00    	add    $0x1000,%ebx
  pte_t *pte;
...
801067f0:	b9 01 00 00 00       	mov    $0x1,%ecx
801067f5:	89 da                	mov    %ebx,%edx
801067f7:	8d 34 3b             	lea    (%ebx,%edi,1),%esi
801067fa:	e8 81 fd ff ff       	call   80106580 <walkpgdir>
801067ff:	85 c0                	test   %eax,%eax
80106801:	75 d5                	jne    801067d8 <mappages+0x38>
      break;
    a += PGSIZE;
    pa += PGSIZE;
  }
...
80106803:	8d 65 f4             	lea    -0xc(%ebp),%esp
...
8010681d:	68 10 78 10 80       	push   $0x80107810
...
80106874:	0f 84 c4 00 00 00    	je     8010693e <switchuvm+0xee>
  ...
  pushcli();
8010687a:	e8 b1 d9 ff ff       	call   80104230 <pushcli>
  mycpu()->gdt[SEG_TSS] = SEG16(STS_T32A, &mycpu()->ts,
8010687f:	e8 4c ce ff ff       	call   801036d0 <mycpu>
80106884:	89 c3                	mov    %eax,%ebx
80106886:	e8 45 ce ff ff       	call   801036d0 <mycpu>
8010688b:	89 c7                	mov    %eax,%edi
8010688d:	e8 3e ce ff ff       	call   801036d0 <mycpu>
80106892:	89 45 e4             	mov    %eax,-0x1c(%ebp)
80106895:	83 c7 08             	add    $0x8,%edi
80106898:	e8 33 ce ff ff       	call   801036d0 <mycpu>
...
801068d9:	bb ff ff ff ff       	mov    $0xffffffff,%ebx
  ...
  mycpu()->gdt[SEG_TSS] = SEG16(STS_T32A, &mycpu()->ts,
                                sizeof(mycpu()->ts)-1, 0);
  mycpu()->gdt[SEG_TSS].s = 0;
801068de:	e8 ed cd ff ff       	call   801036d0 <mycpu>
801068e3:	80 a0 9d 00 00 00 ef 	andb   $0xef,0x9d(%eax)
  mycpu()->ts.ss0 = SEG_KDATA << 3;
801068ea:	e8 e1 cd ff ff       	call   801036d0 <mycpu>
...
80106906:	89 48 0c             	mov    %ecx,0xc(%eax)
  ...
  // forbids I/O instructions (e.g., inb and outb) from user space
  mycpu()->ts.iomb = (ushort) 0xFFFF;
80106909:	e8 c2 cd ff ff       	call   801036d0 <mycpu>
...
8010692b:	5d                   	pop    %ebp
  ...
  lcr3(V2P(p->pgdir));  // switch to process's address space
  popcli();
8010692c:	e9 3f d9 ff ff       	jmp    80104270 <popcli>
// Switch TSS and h/w page table to correspond to process p.
void
switchuvm(struct proc *p)
{
...
80106934:	68 16 78 10 80       	push   $0x80107816
...
80106941:	68 41 78 10 80       	push   $0x80107841
...
8010694e:	68 2c 78 10 80       	push   $0x8010782c
...
80106978:	77 50                	ja     801069ca <inituvm+0x6a>
8010697a:	89 55 e4             	mov    %edx,-0x1c(%ebp)
    panic("inituvm: more than a page");
  mem = kalloc();
8010697d:	e8 fe ba ff ff       	call   80102480 <kalloc>
  memset(mem, 0, PGSIZE);
...
8010698f:	e8 7c da ff ff       	call   80104410 <memset>
  mappages(pgdir, 0, PGSIZE, V2P(mem), PTE_W|PTE_U);
80106994:	8b 55 e4             	mov    -0x1c(%ebp),%edx
80106997:	8d 83 00 00 00 80    	lea    -0x80000000(%ebx),%eax
8010699d:	c7 04 24 06 00 00 00 	movl   $0x6,(%esp)
801069a4:	50                   	push   %eax
801069a5:	68 00 10 00 00       	push   $0x1000
801069aa:	6a 00                	push   $0x0
801069ac:	52                   	push   %edx
801069ad:	e8 ee fd ff ff       	call   801067a0 <mappages>
  memmove(mem, init, sz);
801069b2:	89 75 10             	mov    %esi,0x10(%ebp)
801069b5:	89 7d 0c             	mov    %edi,0xc(%ebp)
801069b8:	83 c4 20             	add    $0x20,%esp
801069bb:	89 5d 08             	mov    %ebx,0x8(%ebp)
}
...
801069c4:	5d                   	pop    %ebp
  ...
  mappages(pgdir, 0, PGSIZE, V2P(mem), PTE_W|PTE_U);
  memmove(mem, init, sz);
801069c5:	e9 f6 da ff ff       	jmp    801044c0 <memmove>
inituvm(pde_t *pgdir, char *init, uint sz)
{
  char *mem;
...
801069cd:	68 55 78 10 80       	push   $0x80107855
...
80106a51:	e8 ea ae ff ff       	call   80101940 <readi>
...
80106a7d:	68 6f 78 10 80       	push   $0x8010786f
...
80106a8a:	68 10 79 10 80       	push   $0x80107910
...
80106ab7:	8b 45 0c             	mov    0xc(%ebp),%eax
  ...
  if(newsz >= KERNBASE)
    return 0;
  if(newsz < oldsz)
80106aba:	0f 82 84 00 00 00    	jb     80106b44 <allocuvm+0xa4>
    return oldsz;
...
80106ace:	77 45                	ja     80106b15 <allocuvm+0x75>
...
80106ae3:	e8 28 d9 ff ff       	call   80104410 <memset>
    if(mappages(pgdir, (char*)a, PGSIZE, V2P(mem), PTE_W|PTE_U) < 0){
80106ae8:	8d 86 00 00 00 80    	lea    -0x80000000(%esi),%eax
80106aee:	c7 04 24 06 00 00 00 	movl   $0x6,(%esp)
80106af5:	50                   	push   %eax
80106af6:	68 00 10 00 00       	push   $0x1000
80106afb:	53                   	push   %ebx
80106afc:	ff 75 08             	pushl  0x8(%ebp)
80106aff:	e8 9c fc ff ff       	call   801067a0 <mappages>
80106b04:	83 c4 20             	add    $0x20,%esp
80106b07:	85 c0                	test   %eax,%eax
80106b09:	78 45                	js     80106b50 <allocuvm+0xb0>
    return 0;
  if(newsz < oldsz)
    return oldsz;
...
80106b11:	39 df                	cmp    %ebx,%edi
80106b13:	76 7b                	jbe    80106b90 <allocuvm+0xf0>
    mem = kalloc();
80106b15:	e8 66 b9 ff ff       	call   80102480 <kalloc>
    if(mem == 0){
...
80106b1c:	89 c6                	mov    %eax,%esi
    if(mem == 0){
80106b1e:	75 b8                	jne    80106ad8 <allocuvm+0x38>
      cprintf("allocuvm out of memory\n");
80106b20:	83 ec 0c             	sub    $0xc,%esp
80106b23:	68 8d 78 10 80       	push   $0x8010788d
...
80106b33:	76 49                	jbe    80106b7e <allocuvm+0xde>
80106b35:	8b 4d 0c             	mov    0xc(%ebp),%ecx
80106b38:	8b 45 08             	mov    0x8(%ebp),%eax
80106b3b:	89 fa                	mov    %edi,%edx
80106b3d:	e8 be fa ff ff       	call   80106600 <deallocuvm.part.0>
  for(; a < newsz; a += PGSIZE){
    mem = kalloc();
    if(mem == 0){
      cprintf("allocuvm out of memory\n");
...
80106b53:	68 a5 78 10 80       	push   $0x801078a5
...
80106b6d:	e8 8e fa ff ff       	call   80106600 <deallocuvm.part.0>
    }
    memset(mem, 0, PGSIZE);
    if(mappages(pgdir, (char*)a, PGSIZE, V2P(mem), PTE_W|PTE_U) < 0){
      cprintf("allocuvm out of memory (2)\n");
...
80106b76:	e8 55 b7 ff ff       	call   801022d0 <kfree>
      return 0;
...
80106bb0:	5d                   	pop    %ebp
80106bb1:	e9 4a fa ff ff       	jmp    80106600 <deallocuvm.part.0>
...
80106be9:	e8 12 fa ff ff       	call   80106600 <deallocuvm.part.0>
...
80106c1e:	e8 ad b6 ff ff       	call   801022d0 <kfree>
...
80106c33:	5d                   	pop    %ebp
  ...
  kfree((char*)pgdir);
80106c34:	e9 97 b6 ff ff       	jmp    801022d0 <kfree>
freevm(pde_t *pgdir)
{
  uint i;
...
80106c3c:	68 c1 78 10 80       	push   $0x801078c1
...
80106c55:	e8 26 b8 ff ff       	call   80102480 <kalloc>
...
80106c70:	e8 9b d7 ff ff       	call   80104410 <memset>
...
80106c7b:	8b 53 08             	mov    0x8(%ebx),%edx
80106c7e:	83 ec 0c             	sub    $0xc,%esp
80106c81:	ff 73 0c             	pushl  0xc(%ebx)
80106c84:	29 c2                	sub    %eax,%edx
80106c86:	50                   	push   %eax
80106c87:	52                   	push   %edx
80106c88:	ff 33                	pushl  (%ebx)
80106c8a:	56                   	push   %esi
80106c8b:	e8 10 fb ff ff       	call   801067a0 <mappages>
80106c90:	83 c4 20             	add    $0x20,%esp
...
80106d0f:	68 d2 78 10 80       	push   $0x801078d2
...
80106d33:	0f 84 c5 00 00 00    	je     80106dfe <copyuvm+0xde>
    return 0;
  for(i = 0; i < sz; i += PGSIZE){
80106d39:	8b 55 0c             	mov    0xc(%ebp),%edx
80106d3c:	85 d2                	test   %edx,%edx
...
80106d60:	e8 5b d7 ff ff       	call   801044c0 <memmove>
    if(mappages(d, (void*)i, PGSIZE, V2P(mem), flags) < 0) {
80106d65:	58                   	pop    %eax
80106d66:	8d 87 00 00 00 80    	lea    -0x80000000(%edi),%eax
80106d6c:	ff 75 e4             	pushl  -0x1c(%ebp)
80106d6f:	50                   	push   %eax
80106d70:	68 00 10 00 00       	push   $0x1000
80106d75:	56                   	push   %esi
80106d76:	ff 75 e0             	pushl  -0x20(%ebp)
80106d79:	e8 22 fa ff ff       	call   801067a0 <mappages>
80106d7e:	83 c4 20             	add    $0x20,%esp
80106d81:	85 c0                	test   %eax,%eax
80106d83:	78 6b                	js     80106df0 <copyuvm+0xd0>
  uint pa, i, flags;
  char *mem;
  ...
  if((d = setupkvm()) == 0)
    return 0;
  for(i = 0; i < sz; i += PGSIZE){
80106d85:	81 c6 00 10 00 00    	add    $0x1000,%esi
80106d8b:	39 75 0c             	cmp    %esi,0xc(%ebp)
80106d8e:	76 50                	jbe    80106de0 <copyuvm+0xc0>
    if((pte = walkpgdir(pgdir, (void *) i, 0)) == 0)
80106d90:	8b 45 08             	mov    0x8(%ebp),%eax
80106d93:	31 c9                	xor    %ecx,%ecx
80106d95:	89 f2                	mov    %esi,%edx
80106d97:	e8 e4 f7 ff ff       	call   80106580 <walkpgdir>
80106d9c:	85 c0                	test   %eax,%eax
80106d9e:	74 6f                	je     80106e0f <copyuvm+0xef>
      panic("copyuvm: pte should exist");
    if(!(*pte & PTE_P))
80106da0:	8b 38                	mov    (%eax),%edi
80106da2:	f7 c7 01 00 00 00    	test   $0x1,%edi
80106da8:	74 58                	je     80106e02 <copyuvm+0xe2>
      panic("copyuvm: page not present");
    pa = PTE_ADDR(*pte);
80106daa:	89 fb                	mov    %edi,%ebx
    flags = PTE_FLAGS(*pte);
80106dac:	81 e7 ff 0f 00 00    	and    $0xfff,%edi
80106db2:	89 7d e4             	mov    %edi,-0x1c(%ebp)
  for(i = 0; i < sz; i += PGSIZE){
    if((pte = walkpgdir(pgdir, (void *) i, 0)) == 0)
      panic("copyuvm: pte should exist");
    if(!(*pte & PTE_P))
      panic("copyuvm: page not present");
    pa = PTE_ADDR(*pte);
80106db5:	81 e3 00 f0 ff ff    	and    $0xfffff000,%ebx
    flags = PTE_FLAGS(*pte);
    if((mem = kalloc()) == 0)
80106dbb:	e8 c0 b6 ff ff       	call   80102480 <kalloc>
80106dc0:	85 c0                	test   %eax,%eax
80106dc2:	89 c7                	mov    %eax,%edi
80106dc4:	75 8a                	jne    80106d50 <copyuvm+0x30>
    }
  }
  return d;
...
80106dc9:	ff 75 e0             	pushl  -0x20(%ebp)
80106dcc:	e8 ff fd ff ff       	call   80106bd0 <freevm>
  return 0;
80106dd1:	83 c4 10             	add    $0x10,%esp
80106dd4:	31 c0                	xor    %eax,%eax
}
...
80106df4:	e8 d7 b4 ff ff       	call   801022d0 <kfree>
      goto bad;
80106df9:	83 c4 10             	add    $0x10,%esp
80106dfc:	eb c8                	jmp    80106dc6 <copyuvm+0xa6>
  pte_t *pte;
  uint pa, i, flags;
  char *mem;
  ...
  if((d = setupkvm()) == 0)
    return 0;
80106dfe:	31 c0                	xor    %eax,%eax
80106e00:	eb d4                	jmp    80106dd6 <copyuvm+0xb6>
  for(i = 0; i < sz; i += PGSIZE){
    if((pte = walkpgdir(pgdir, (void *) i, 0)) == 0)
      panic("copyuvm: pte should exist");
    if(!(*pte & PTE_P))
...
80106e05:	68 f6 78 10 80       	push   $0x801078f6
80106e0a:	e8 61 95 ff ff       	call   80100370 <panic>
...
80106e12:	68 dc 78 10 80       	push   $0x801078dc
...
80106e2e:	e8 4d f7 ff ff       	call   80106580 <walkpgdir>
  if((*pte & PTE_P) == 0)
...
80106e9f:	e8 1c d6 ff ff       	call   801044c0 <memmove>
    len -= n;
    buf += n;
